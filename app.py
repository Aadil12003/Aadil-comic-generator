...
def generate_comic_script(idea, style, panels):
    ...
    2. Character Consistency (CRITICAL): Define the exact visual identity as tags e.g., '[Character Name], age [Age], [tags like: blonde pixie-cut, leather jacket, scar]'. Repeat these exact tags in EVERY single image_prompt.
